...
const EXACT_ZH_TO_EN: Record<string, string> = {
  ...
  "系统配置": "System Config",
  "服务状态": "Service Status",
  "系统运行状态监控": "System runtime status monitoring",
  "时间窗": "Time Window",
  ...
  "信息": "Info",
  "检索": "Search",
  "标题/状态/指标": "Title / Status / Metrics",
  "自动刷新": "Auto Refresh",
  "重置筛选": "Reset Filters",
  "运行摘要": "Runtime Summary",
  "最新": "Latest",
  "最近采样": "Last Sample",
  "服务状态数据加载中...": "Service status data is loading...",
  "当前告警": "Current Alerts",
  "总计 {{count}}": "Total {{count}}",
  "无告警": "No Alerts",
  "当前未检测到活动告警。": "No active alerts detected.",
  "代码：{{code}}": "Code: {{code}}",
  "其余 {{count}} 条告警请使用筛选查看。": "Use filters to view remaining {{count}} alerts.",
  "服务卡片": "Service Cards",
  "仅异常：{{visible}} / {{total}}": "Alerting only: {{visible}} / {{total}}",
  "共 {{count}} 张卡片": "{{count}} cards total",
  "仅异常": "Alerting Only",
  "当前无异常卡片": "No alerting cards",
  "暂无服务卡片": "No service cards",
  "监听地址": "Listen Address",
  "队列状态": "Queue State",
  "队列使用率": "Queue Usage",
  "丢弃率": "Drop Rate",
  ...
  "累计出站": "Total Egress",
  "流量趋势": "Traffic Trend",
  "入站/出站吞吐速率": "Inbound/Outbound Throughput",
  "暂无流量趋势数据": "No traffic trend data",
  "队列趋势": "Queue Trend",
  "队列使用率与丢弃率": "Queue Usage and Drop Rate",
  "暂无队列趋势数据": "No queue trend data",
  "内存趋势": "Memory Trend",
  "堆内存使用率": "Heap Usage Rate",
  "暂无内存趋势数据": "No memory trend data",
  "趋势图自动适配时间窗，支持无数据空态展示。": "Trend charts adapt to time window and support empty state.",
  "诊断操作": "Diagnostics Actions",
  "可复制当前窗口的服务快照（状态、衍生指标、告警），便于排障与回溯。": "Copy current window snapshot (status, derived metrics, alerts) for troubleshooting.",
  "复制快照": "Copy Snapshot",
  "已复制": "Copied",
  "跳转告警": "Jump to Alerts",
  "跳转趋势": "Jump to Trends",
  ...
  "未知": "Unknown",
  "高负载": "High Load",
  "告警：代理健康状态异常": "Alert: Proxy health anomaly",
  "告警：队列进入降级状态": "Alert: Queue entered degraded state",
  "告警：队列使用率过高": "Alert: Queue usage too high",
  "告警：丢弃率过高": "Alert: Drop rate too high",
  "告警：丢弃率升高": "Alert: Drop rate elevated",
  "告警：内存压力过高": "Alert: Memory pressure too high",
  "告警：内存压力升高": "Alert: Memory pressure elevated",
  "告警：队列刷新失败增长": "Alert: Queue flush failures increased",
  "未启用": "Not Enabled",
  "版本信息": "Version Info",
  "资源使用": "Resource Usage",
  "运行时长": "Uptime",
  ...
  "环境配置已复制": "Environment config copied",
  "复制失败，请手动复制": "Copy failed, please copy manually",
  "一键复制": "Copy",
  "写入 {{file}}": "Write to {{file}}",
  "默认示例使用 Platform:RESIN_PROXY_TOKEN@IP:Port。": "Default example uses Platform:RESIN_PROXY_TOKEN@IP:Port.",
  "已使用当前平台名、RESIN_PROXY_TOKEN 与监听地址自动生成。": "Generated with current platform name, RESIN_PROXY_TOKEN, and listen address.",
  "HTTP 与 SOCKS5 环境变量配置示例": "HTTP and SOCKS5 environment variable examples",
